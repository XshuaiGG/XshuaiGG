 ...
 * Generated at: 2020-03-05 09:06:21 UTC
...
public final class user_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\tplaceholder=\"用户名称\" value=\"\" onchange=\"checkUser()\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"btn bg-maroon\" id=\"btn\">保存</button>\r\n");
      ...
      out.write("\t\t\t\t//1. 获取输入的用户名\r\n");
      out.write("\t\t\t\tvar name = $(\"#username\").val();\r\n");
      out.write("\t\t\t\t//2.发送一个ajax异步请求 ,得到后台返回的字符串\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/isUniqueUsername',\r\n");
      out.write("\t\t\t\t\tdataType:'json',\r\n");
      out.write("\t\t\t\t\tdata:{username:name},\t//请求参数\r\n");
      out.write("\t\t\t\t\ttype:'post',\t//指定请求方式\r\n");
      out.write("\t\t\t\t\tsuccess:function(data){\t//回调函数 ,获取后台响应过来的流数据\r\n");
      out.write("\t\t\t\t\t\tif(data==true){\t\t//用户名不存在,可以使用\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#username\").prop(\"style\",\"\");\t//清除样式\r\n");
      out.write("\t\t\t\t\t\t\t//$(\"#btn\").prop(\"disabled\",false);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#btn\").show();\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\tif(data==false){\t//已重名,用户已存在,不能使用\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#username\").prop(\"style\",\"border:red 1px solid\");\t//加入红框提示\r\n");
      out.write("\t\t\t\t\t\t\t//$(\"#btn\").prop(\"disabled\",true);\t//代表按钮不能点击\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#btn\").hide();\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
