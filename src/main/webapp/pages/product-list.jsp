...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<!--数据列表-->
						<form id="delete-form" action="${pageContext.request.contextPath}/product/deleteMore" method="post">
						<table id="dataList"
	...
	<script type="text/javascript">
		...
		//当选中下拉列表中的pageSize时,给当前<option> 加上 属性 selected=selected
		// 组合选择器  id + 元素 + 属性
		$("#pageSize option[value=${pageBean.pageSize}]").prop("selected","selected");

		//手动分页相关内容
		function gotoPage(currPage) {
			//获取到下拉列表中的 pagesize的值
		...
		function deleteMore() {
			if(confirm("确实是否删除?")) {
				var delForm = $("#delete-form");	//拿到 form表单对象
				delForm.submit();	//提交表单
			}
		}
	</script>
